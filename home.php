<html>
    ...
    <body>        
        ...
        <div class="title-box">
            ...
            <div class="dotted" style="width: 40px; margin-top: 15px; margin-left: -15px;"></div>
            <div class="dotted" style="width: 130px; margin-top: 75px; margin-left: -25px;"></div>
            <div class="dotted" style="height: 85px; margin-top: 5px; margin-left: -10px;"></div>
            <div class="dotted" style="height: 60px; margin-top: 55px; margin-left: 55px;"></div>
