<html>
    ...
    <body>        
        ...
        <a id="bitmosef-container" href="about-me.php" tabindex="-1">
            <div>
                <div class="shadow"></div>
                <img id="bitmosef-head" src="assets/icons/head.png">
                <img id="bitmosef-glasses" src="assets/icons/glasses.png">
                <img id="bitmosef-hand-l" src="assets/icons/hand.png">
                <img id="bitmosef-hand-r" src="assets/icons/hand.png">
            </div>

            <div id="bitmosef-bubble">
                <div id="bubble-container">
                    <img src="assets/icons/bubble-icon.png">
                    <div class="bubble-txt">hi!</div>
                </div>
            </div>

            <div id="bitmosef-hide">
                <div id="hide-button"> 
                    <div id="close-button" onclick="hideBitmoji()">
            ...
            <div class="spacer"></div>
                <div class="articles-container">
                    ...
                    <div class="panel-line">
                        ...
                        <div>
                            <div class="tip">
                                ...
                                <div>
                                    <p>
                                        You can <u>navigate</u> through the website by pressing the <tt>tab</tt> key.
                                    </p>
                                    <div>
                                        <img src="assets/icons/tab.png" height="65px">
                                    </div>
                                    <p>
                                        To <u>press a button</u> / <u>follow a link</u>, press <tt>enter</tt> on the selected link. <br>
                                        You can even <u>browse backwards</u> by pressing <tt>shift</tt> + <tt>tab</tt> !
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="game-article">
                        ...
                        <div class="thumbnail">
                            <img src="assets/thumbnails/potsdealer.png">
                        </div>
                        ...
                        <div class="article-content">
                            ...
                            <p>
                                ...
                                occasion of the <a href="https://gamejam.com/jam/scorejam12/submissions" target="blank" class="bright">ScoreSpace Jam #12</a>.
                            </p>
                            <div id="collab-rm" class="read-more">
                                <div class="spacer"><div class="stroke"></div></div>
                                <span onclick="readMore('collab')">Read more...</span>
                                <div class="spacer"><div class="stroke"></div></div>
                            </div>
                            <p id="collab-text" class="hidden">
                                ...
                                We reached the <span class="bright">4th position</span>  (among 94 participants !) and we keep polishing stuff to make it something <span class="bright">bigger</span>. 🧐 <br>
